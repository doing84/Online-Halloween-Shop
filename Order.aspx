<%@ Page Title="" Language="C#" MasterPageFile="~/Checkout.master" AutoEventWireup="true" CodeFile="Order.aspx.cs" Inherits="Order" %>
<%@ MasterType VirtualPath="~/Checkout.master" %>

<asp:Content ID="headContent" ContentPlaceHolderID="headPlaceHolder2" Runat="Server">  
    <link href="Styles/Order.css" rel="stylesheet" />    
</asp:Content>

<asp:Content ID="formContent" ContentPlaceHolderID="formPlaceHolder2" Runat="Server">
...
<asp:Content ID="Content3" ContentPlaceHolderID="footerPlaceHolder2" runat="Server"></asp:Content>
